...
export function AccordionGallery({
  ...
  const amber  = light ? '#22d3ee' : '#f0b429'
  const overlay = '#050b14'
    ...
    (animate: boolean) => {
      ...
      panels.forEach((panel, i) => {
        ...
        if (media) {
          ...
          // Use GSAP to animate filter directly — avoids TS style object issues
          tl.to(
            media,
            {
              xPercent: -50,
  ...
  return (
    // perspective wrapper is separate from the flex container to avoid overflow bleed
            ...
            >
              ...
              <span className="absolute inset-0 overflow-hidden [border-radius:inherit]">
                ...
                <span
                  ...
                  style={{
                    background: `linear-gradient(180deg, transparent 40%, ${overlay}cc 100%)`,
                  }}
                />
              </span>
              ...
              >
                ...
                <span className="flex min-w-0 flex-col gap-1">
                  ...
                  <span
                    ...
                    className="truncate font-display text-[clamp(1rem,1.4vw,1.6rem)] font-semibold leading-tight text-white opacity-0 [text-shadow:0_2px_16px_rgba(0,0,0,0.6)]"
                  >
                    {car.name}
                  </span>
                </span>
